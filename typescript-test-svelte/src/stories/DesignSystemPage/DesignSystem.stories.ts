...
Our design system builds on defining on weights when defining style attributes, weight means how visually heavy the element becomes on the page <br>_(\`100\` is the lightest \`300\` is base and \`500\` is the heaviest)_

_Below is an overview of the system_
`
